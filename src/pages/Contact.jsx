          ...
          <form className="space-y-6">
            <div>
              ...
              <input
                type="text"
                placeholder="abc"
                className="w-full px-4 py-2 bg-gray-100 text-black border border-gray-300 rounded-xl placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
