...
const FilterSection = ({serach, setSearch , brand, setBrand,  priceRange , setPriceRange, category ,setCategory, handleBrandChange, handleCategoryChange  }) => {
  ...
  return (
    ...
    <button className="bg-red-500 text-white rounded-md px-3 py-3 mt-5 cursor-pointer hover:bg-red-800"
